...
public class caso10 {
	...
	public static void main(String[] args) {
		...
		while (respo.equals("S") || respo.equals("s")) {
			...
			if (tardan <= 15) des = 0;
			else if (tardan > 15 & tardan <= 30) des = (sue_bru * 0.003f) * tardan;
			else if (tardan > 30) des = (sue_bru * 0.005f) * tardan;
			
			float meta = (hor_tra*100)/80;
			float sue_neto = sue_bru + bon - des;
			
			System.out.println("Sueldo bruto: " + sue_bru);
			System.out.println("Bonificación: " + bon);
			System.out.println("Descuento: " + des);
			System.out.println("Sueldo neto: " + sue_neto);
		...
		System.out.println("Sueldo neto menor: " + su_men + " pertenece a: " + nom_2);
